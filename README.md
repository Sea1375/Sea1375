...
Hi. I'm a senior Blockchain and Fullstack developer who likes to work with Blockchain(Bitcoin, Ethereum, Solidity, ERC20, ERC721, ERC1155), JavaScript/Typescript (React, Angular, Vue.js, Node, Nest), Python (Django, Flask), PHP (Laravel, CodeIgniter), and so on.
